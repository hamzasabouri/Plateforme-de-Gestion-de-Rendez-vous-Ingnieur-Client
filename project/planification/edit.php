...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `planification` SET `ressources`='$ressources',`project`='$project',`date`='$date',`time`='$time' WHERE id = $id";
...
<html lang="en" dir="ltr">
  ...
  <head>
    ...
    <meta charset="UTF-8">
    <title>Modifier Planification</title>
...
<form class="form" action=""S method="post">
  <p class="title">Modifier Planification </p>
  <div class="select">
  <?php
    $sql = "SELECT * FROM `planification` WHERE id = $id LIMIT 1";
