...
if (isset($_GET['startDate']) && isset($_GET['endDate'])) {
  $formattedStartDate = $_GET['startDate'];
  $formattedEndDate = $_GET['endDate'];
  // Maintenant, vous pouvez utiliser $formattedStartDate et $formattedEndDate dans cette page




// استعلام لاسترداد جميع البيانات المرتبطة بالأسبوع المحدد
$query1 = "SELECT * FROM planification WHERE date BETWEEN '$formattedStartDate' AND '$formattedEndDate'";
...
<section class="home-section">
  ...
  <div class="home-content">
    ...
    ?>
    <a href="add_new.php" class="btn btn-dark mb-3">Ajouter Planification</a>
    
    <a href="export.php"> <button type="button" name="button" class="btn btn-dark mb-3">Export To Excel</button> </a>

    <a href="search.php" class="submit">Search</a>
