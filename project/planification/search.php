...
<html lang="en" dir="ltr">
  ...
  <head>
    ...
    <meta charset="UTF-8">
    <title>Search Planification</title>
...
<section class="home-section">
  <div class="home-content">
    ...
    <br><br><br> <p class="title">Search Data Planification </p>
    <div class="card-body">
                        <div class="row">
                            <div class="col-md-7">
    ...
    <table class="table table-hover text-center" style="size" >
      ...
      <tbody>
                                <?php 
                                    $con = mysqli_connect("localhost","root","","ressources");

                                    if(isset($_GET['search']))
                                    {
                                        $filtervalues = $_GET['search'];
                                        $query4 = "SELECT * FROM planification WHERE CONCAT(ressources,project,date,time) LIKE '%$filtervalues%' ";
